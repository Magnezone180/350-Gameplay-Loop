...
[67.0,1.2,0.0],[70.0,1.2,0.0],[75.0,2.4,0.2],[79.0,0.8,0.0],[77.0,0.4,0.0],[75.0,1.2,0.0], [67.0,1.2,0.1],[69.0,1.2,0.2]] @=> float banner[][];
// play through our data table first
0 => int i;
while (i < banner.cap()) { 
    banner[i][2] => jimi.lfoDepth; pick(banner[i][0],banner[i][1]); 1 +=> i;
}
// play last note longer, then
Std.mtof(82) => jimi.freq; 1 => jimi.noteOn;
2.0 :: second => now;
// go nuts and sweep frequency downward
while (jimi.freq() > 100.0) 
{ 
