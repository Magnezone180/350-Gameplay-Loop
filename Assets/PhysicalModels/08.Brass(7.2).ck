...
Brass trump => NRev rev => dac; 0.1 => rev.mix;
...
while (i < notes.cap()-1)
{
    ...
    0.1 :: second => now; 1 => trump.stopBlowing; 0.05 :: second => now; i++;
}
// add a little breath vibrato for last note
0.4 => trump.vibratoGain; 0.8 => trump.startBlowing;
Std.mtof(notes[i]) => trump.freq; 
second => now; 1 => trump.stopBlowing; second => now;
